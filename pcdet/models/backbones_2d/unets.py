...
class U_Net(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=1):
        ...
        in_ch = 16
        filters = [in_ch, in_ch * 2, in_ch * 4, in_ch * 8, in_ch * 16]
...
class R2AttU_Net(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        x = batch_dict['inpus_bev_feature']

        e1 = self.RRCNN1(x) # [4, 32, 608, 608]

        e2 = self.Maxpool1(e1)
        e2 = self.RRCNN2(e2) # [4, 64, 304, 304]

        e3 = self.Maxpool2(e2)
        e3 = self.RRCNN3(e3) # [4, 128, 152, 152]

        e4 = self.Maxpool3(e3)
        e4 = self.RRCNN4(e4) # [4, 256, 76, 76]

        e5 = self.Maxpool4(e4)
        e5 = self.RRCNN5(e5) # [4, 512, 38, 38]
        ...
        batch_dict['output_bev_feature'] = out
